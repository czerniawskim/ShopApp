 ...
 */
final class Version20190824093316 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE admin (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('DROP INDEX IDX_BEAF78D0A76ED395');
        $this->addSql('DROP INDEX IDX_BEAF78D06C8A81A9');
        $this->addSql('CREATE TEMPORARY TABLE __temp__opinions AS SELECT id, products_id, user_id, description, rate FROM opinions');
        $this->addSql('DROP TABLE opinions');
        $this->addSql('CREATE TABLE opinions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, products_id INTEGER NOT NULL, user_id INTEGER NOT NULL, description CLOB NOT NULL COLLATE BINARY, rate INTEGER NOT NULL, CONSTRAINT FK_BEAF78D06C8A81A9 FOREIGN KEY (products_id) REFERENCES products (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BEAF78D0A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO opinions (id, products_id, user_id, description, rate) SELECT id, products_id, user_id, description, rate FROM __temp__opinions');
        $this->addSql('DROP TABLE __temp__opinions');
        $this->addSql('CREATE INDEX IDX_BEAF78D0A76ED395 ON opinions (user_id)');
        $this->addSql('CREATE INDEX IDX_BEAF78D06C8A81A9 ON opinions (products_id)');
        $this->addSql('DROP INDEX IDX_B3BA5A5A12469DE2');
        $this->addSql('CREATE TEMPORARY TABLE __temp__products AS SELECT id, category_id, name, price, description, image, gallery_link FROM products');
        ...
        $this->addSql('INSERT INTO products (id, category_id, name, price, description, image, gallery_link) SELECT id, category_id, name, price, description, image, gallery_link FROM __temp__products');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin ADD COLUMN level INTEGER NOT NULL');
        $this->addSql('DROP INDEX IDX_B78FCCA0A21214B7');
        $this->addSql('DROP INDEX IDX_B78FCCA08D7B4FB4');
        $this->addSql('CREATE TEMPORARY TABLE __temp__categories_tags AS SELECT categories_id, tags_id FROM categories_tags');
        $this->addSql('DROP TABLE categories_tags');
        ...
        $this->addSql('DROP INDEX IDX_BEAF78D06C8A81A9');
        $this->addSql('DROP INDEX IDX_BEAF78D0A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__opinions AS SELECT id, products_id, user_id, rate, description FROM opinions');
        $this->addSql('DROP TABLE opinions');
        $this->addSql('CREATE TABLE opinions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, products_id INTEGER NOT NULL, user_id INTEGER NOT NULL, rate INTEGER NOT NULL, description CLOB NOT NULL)');
        $this->addSql('INSERT INTO opinions (id, products_id, user_id, rate, description) SELECT id, products_id, user_id, rate, description FROM __temp__opinions');
        $this->addSql('DROP TABLE __temp__opinions');
        $this->addSql('CREATE INDEX IDX_BEAF78D06C8A81A9 ON opinions (products_id)');
        $this->addSql('CREATE INDEX IDX_BEAF78D0A76ED395 ON opinions (user_id)');
        $this->addSql('DROP INDEX IDX_B3BA5A5A12469DE2');
        $this->addSql('CREATE TEMPORARY TABLE __temp__products AS SELECT id, category_id, name, price, description, image, gallery_link FROM products');
        $this->addSql('DROP TABLE products');
        $this->addSql('CREATE TABLE products (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, description CLOB DEFAULT NULL, image BLOB NOT NULL, gallery_link VARCHAR(750) DEFAULT NULL)');
        $this->addSql('INSERT INTO products (id, category_id, name, price, description, image, gallery_link) SELECT id, category_id, name, price, description, image, gallery_link FROM __temp__products');
        $this->addSql('DROP TABLE __temp__products');
        $this->addSql('CREATE INDEX IDX_B3BA5A5A12469DE2 ON products (category_id)');
    }
